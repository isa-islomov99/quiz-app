...
const continue_btn = info_box.querySelector(".restart");
const quiz_box = document.querySelector(".quiz_box");
const step_box = document.querySelector(".step_box");
const next_step_btn = step_box.querySelector(".next_step_btn");
const timer_sec = quiz_box.querySelector(".timer");
const time_line = quiz_box.querySelector(".time_line");
const result_box = document.querySelector(".result_box");
const quitBtn = result_box.querySelector(".quit");
...
next_step_btn.onclick = () => {
  step_box.classList.remove("activeStep");
  quiz_box.classList.add("activeQuiz");
  document.body.style.background = "#328dee";
  countStepNext = setTimeout(stepNextQues, 300);
};
